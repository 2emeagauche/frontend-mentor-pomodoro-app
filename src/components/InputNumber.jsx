  ...
  return (
    <div className="form-setting__time-input-wrapper">
        ...
        <div className="time-input__arrow-buttons">
            <button className="time-input__arrow-button" id={`incrementBtn${inputId}`} type="button" onClick={increment} aria-label="increment by one">
            ...
            <button className="time-input__arrow-button" id={`decrementBtn${inputId}`} type="button" onClick={decrement} aria-label="decrement by one">
              <svg className="time-input__arrow-button__icon" xmlns="http://www.w3.org/2000/svg" width="14" height="7">
